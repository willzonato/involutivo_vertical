...
```{r runif, fig.cap = "Simulação de variável com distribuição uniforme", fig.asp = 0.5}
v <- runif(10^5)
hist(v, freq = FALSE)
curve(dunif(x),
...
```{r rnorm, fig.cap = "Simulação de variável com distribuição normal", fig.asp = 0.5}
...
```{r rbeta1, fig.cap = "Simulação de variável com distribuição beta (fatores de forma iguais a 4)", fig.asp = 0.5}
...
```{r rbeta2, fig.cap = "Simulação de variável com distribuição beta (fatores de forma iguais a 1)", fig.asp = 0.5}
